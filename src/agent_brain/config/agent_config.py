...
class AgentSettings(BaseSettings):
    ROUTER_MODEL: str = Field(default="qwen2.5:14b-instruct-q6_K", env="ROUTER_MODEL")
    WORKER_MODEL: str = Field(default="qwen2.5:14b-instruct-q6_K", env="WORKER_MODEL")
    RESPONSE_MODEL: str = Field(default="qwen2.5:14b-instruct-q6_K", env="RESPONSE_MODEL")

...
- 2.7.4 Vietnamese language considerations: Vietnamese is tonal (6 tones), monosyllabic but with compound words ("bún bò Huế" is one lexical unit). Tokenization via underthesea for BM25. Vietnamese embedding models — bkai-foundation-models/vietnamese-bi-encoder (768-dim), AITeamVN/BGE-M3 (1024-dim), PhoBERT variants

...
>
> **Cross-refs:** §2.1 (overview — commercial robot limitations), §2.8 (edge compute platform), §3.2 (navigation requirements), §3.5–§3.8 (proposed navigation method), §5.2 (navigation experiments)
